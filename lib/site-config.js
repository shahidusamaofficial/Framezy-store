...
export const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || "https://framezy.netlify.app").replace(/\/$/, "");
export const SITE_NAME = "Framezy";
...
// Fill these in via .env.local / your Netlify env vars once you have real
...
export const BUSINESS = {
  ...
  email: process.env.NEXT_PUBLIC_BUSINESS_EMAIL || "hello@framezy.pk",
